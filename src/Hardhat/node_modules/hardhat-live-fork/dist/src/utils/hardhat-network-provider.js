...
exports.getHardhatNetworkProvider = void 0;
/**
 ...
 */
const getHardhatNetworkProvider = async (ethereumProvider) => {
    ...
    while (provider._wrapped !== undefined) {
        ...
        if (currentLoopIterations > maxLoopIterations) {
            throw new Error(`LiveFork: unable to find base hardhat provider. are you sure you're running locally?`);
        }
    }
...
exports.getHardhatNetworkProvider = getHardhatNetworkProvider;
//# sourceMappingURL=hardhat-network-provider.js.map