...
const maxSubaddressLen = 54; // The maximum length of `int64` as a string.
...
export class Address {
  ...
  get namespaceLength() {
    if (this.protocol() !== Protocol.DELEGATED) throw new Error('Can only get namespace length for delegated addresses');
...
export function newDelegatedAddress(namespace, subAddr, coinType) {
  ...
  return newAddress(Protocol.DELEGATED, uint8arrays.concat([namespaceByte, subAddr]), coinType);
}
/**
